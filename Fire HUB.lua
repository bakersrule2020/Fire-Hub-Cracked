...
function executeScript(gameName)warn("Converting ["..gameName.."] to ["..gameName..".lua]...") gameName = tostring(gameName)..".lua" warn("Found script for game: "..tostring(id).." ("..name..") - "..gameName)warn("Executing "..gameName.."...")loadstring(game:HttpGet("https://raw.githubusercontent.com/InfernusScripts/Fire-Hub/main/"..gameName))()warn(gameName.." has been successfuly executed!")end
